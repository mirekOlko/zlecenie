...
<button onclick="myFunction2()">PKO Leasing</button><script>function myFunction2() {
 dataLeasing();
document.getElementById("198").selected=true;document.getElementById("zlec8").selected=true;document.getElementById("forma_platnosci3").selected=true;}</script>';

$echo.='<form id="form1" name="form1" method="post" action="dodaj_faktu_hurtowe.php">
<table border="1">
<tr><td>LP.</td><td>Numer faktury </td><td>wartość faktury:</td><td>w tym VAT:</td></tr>';

for($i=1;$i<9;$i++)
     $echo.='<tr><td>'.$i.'</td>
                 <td><input name="numer_faktury_'.$i.'" type="text" size="34" wrap="physical" maxlength="34" /></td>
                 <td><input name="wartosc_faktury_'.$i.'" type="text" size="34" wrap="physical" maxlength="34" /> </td>
                 <td><input name="wartosc_VAT_'.$i.'" type="text" size="34" wrap="physical" maxlength="34" /> </td>
    	     </tr>';
...
<tr><td>czy zapłacona:</td>
	...
	<option id="zaplaconaNie" value="0" selected>NIE</option>
